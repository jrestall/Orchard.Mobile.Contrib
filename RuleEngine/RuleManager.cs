...
namespace Orchard.Mobile.Contrib.RuleEngine
{
    public class RuleManager : IRuleManager {
        private readonly IEnumerable<IDeviceGroupRuleProvider> _ruleProviders;
        private readonly IEnumerable<IScriptExpressionEvaluator> _evaluators;

        public RuleManager(IEnumerable<IDeviceGroupRuleProvider> ruleProviders, IEnumerable<IScriptExpressionEvaluator> evaluators) {
